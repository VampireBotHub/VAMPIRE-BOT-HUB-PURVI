...
BOT_NAME = getenv("BOT_NAME" , "PURVI")
ASSUSERNAME = getenv("ASSUSERNAME" , "THUNDER")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/VampireBotHub/VAMPIRE-BOT-HUB-PURVI",)
